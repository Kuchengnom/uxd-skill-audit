...
Stichproben gegen die Primärquellen bestätigen die Sorgfalt. Kontrast 4,5:1 für Text, 3:1 für UI-Komponenten: korrekt. Mindest-Zielgröße 24 × 24 px unter Verweis auf WCAG 2.5.8: korrekt. Die als neu in 2.2 genannten Kriterien — Focus Not Obscured, Target Size, Accessible Authentication: korrekt zugeordnet. Die Fokusfalle wird gegen 2.4.3 und 2.1.2 geprüft: die richtigen Kriterien.
...
Neben diesem Apparat steht eine zweite Ebene mit gänzlich anderer epistemischer Qualität: `design-systems/library/` mit 138 „brand-grade" Spezifikationen — apple, linear, stripe, vercel, notion, spotify, tesla. Aufgerufen wird sie über `/apply-aesthetic stripe`, mit der Beschreibung „make the dashboard feel like Stripe".
