...
Am 17. April 2026 veröffentlichte Anthropic Claude Design, einen KI-basierten visuellen Workspace der HTML-Artefakte aus Textbeschreibungen generiert. Das neue Format dafür heißt DESIGN.md: eine Markdown-Datei die Claude mitteilt, welche Ästhetik ein Projekt haben soll, also Farben, Typografie, Abstände und Komponentenverhalten. Ohne DESIGN.md produziert Claude Design generische Ausgaben. Mit einer guten DESIGN.md soll unverwechselbare Markenpräsenz entstehen.

Einen Tag nach dem Launch veröffentlichte Rohit Ghumare unter dem Namen `rohitg00` das Repository `awesome-claude-design`. Die Idee: mehr als 28 produktionsfertige DESIGN.md-Dateien, sortiert nach neun ästhetischen Familien. Dazu zählen Neon Brutalist, Editorial Minimalism, Warm Editorial, Terminal-Core, Data-Dense Pro, Cinematic Dark, Playful Color, Glass/Soft-Futurism und Cult/Indie. Wer ein „The-Verge-artiges Interface" bauen will, greift zur entsprechenden Datei und übergibt sie an Claude Design.

Das Repository erreichte bis Anfang Juni 2026 über 360 GitHub-Stars und wurde in zahlreichen Design-Blogs als Referenz-Ressource zitiert. Es ist damit das meistverlinkte DESIGN.md-Projekt im Ökosystem und für diesen Blog interessant genug für eine genaue Betrachtung.
...
`awesome-claude-design` enthält DESIGN.md-Dateien. Das ist deklaratives Wissen: So sieht das Ergebnis aus, nicht so kommt man dahin. Die DESIGN.md für The Verge listet Farbwerte wie `--accent: #ff6600`, Typografieregeln mit Polysans Median als Display-Schrift, Abstands- und Layout-Entscheidungen wie 2px-Rules statt Whitespace, und einen „Agent Prompt Guide" der Claude explizit sagt was es ablehnen soll: abgerundete Ecken, weiche Schatten, Pastellpaletten, Inter als Display-Schrift.

Das ist handwerklich korrekt recherchiert. Polysans Median ist tatsächlich The Verges Wahl für Display-Typografie. Das Orange #ff6600 ist eine akkurate Näherung an The Verges Akzentfarbe. Die 2px-Rule-Ästhetik und der Verzicht auf Kartenabtrennungen durch Hintergrundfarben stimmen mit dem Markenauftritt überein. Hier hat jemand wirklich nachgeschaut, nicht nur Kategorien benannt.
...
Für den Unterrichtseinsatz ist das ein wichtiger Unterschied. Die einzelnen DESIGN.md-Dateien sind citable und verifizierbar: The Verge öffnen, Schrift prüfen, Farbe prüfen. Die Taxonomie der Familien ist es nicht.
...
Dieser Teil des Repos hat einen didaktischen Wert der über die DESIGN.md-Dateien hinausgeht. Er macht ein strukturelles Problem sichtbar, nämlich dass KI-Generierung zu statistischen Mittelmäßen konvergiert, und gibt Werkzeuge um dagegen zu arbeiten. Für den Unterrichtseinsatz ist das eine gute Ausgangsbasis für die Frage: Wie kommuniziert man Designintention so präzise, dass das Modell keine Lücken mit Defaults füllen kann?
...
Diese Übung lehrt drei Dinge gleichzeitig. Wie DESIGN.md als Format funktioniert. Wie man Designentscheidungen auf ihre tatsächliche Herkunft zurückverfolgt. Und warum der Abstand zwischen „Stilbeschreibung" und „Designprinzip" größer ist als er zunächst erscheint.
