...
Das Repository ist klein und fokussiert: drei Agenten, drei Commands, vier Skills. Die Auswahl der behandelten Designer ist kanonisch und vertretbar: Saul Bass, Massimo Vignelli, Dieter Rams, Paula Scher, Josef Müller-Brockmann, David Carson und Paul Rand. Die Zitate sind überwiegend authentisch. Und dennoch enthält der Ansatz eine epistemische Lücke, die im Unterricht sorgfältig diskutiert werden sollte.

## Was das Repository enthält

Der Kern des Projekts ist der `design-masters`-Skill. Für jeden der sieben Designer liefert er eine Kurzbiografie, zentrale Zitate, Signatur-Techniken und ausgewählte Werke. Dazu kommt der kritische Teil: ein „Apply His/Her Lesson"-Abschnitt, der eine schrittweise Arbeitsanleitung formuliert.
...
Für Dieter Rams gibt es den „Rams Test" mit drei Fragen, die man an jedes Designelement stellen soll, bevor man es beibehält. Für Massimo Vignelli eine Übung mit zwei Schriftarten, drei Farben und vier Abstandswerten.
...
Die Warnungen bei David Carson sind ein Positivbeispiel. Der Skill markiert explizit, für welche Kontexte seine Anti-Design-Prinzipien geeignet sind, nämlich kreative Portfolios und Marketing das Aufmerksamkeit braucht, und für welche nicht: Navigation, Rechtstexte, Marken mit Konformitätserfordernissen. Das ist eine der wenigen Stellen im Skill, an der Grenzen aktiv kommuniziert werden. Es zeigt, dass der Ansatz prinzipiell zu sinnvoller Transparenz fähig ist.

Die Vergleichstabelle am Ende des `design-masters`-Skills beantwortet die Frage, wer für welchen Kontext am nützlichsten ist. Auch sie ist brauchbar. Sie gibt Nutzenden einen Einstiegspunkt in kontextualisierte Auswahl statt universeller Anwendung.

Die Auswahl der sieben Designer ist vertretbar. Bass, Vignelli, Rams, Scher, Müller-Brockmann, Carson und Rand decken unterschiedliche Epochen, Medien und Philosophien ab. Wer die Reihe im Unterricht durcharbeiten würde, hätte tatsächlich einen Überblick über wesentliche Strömungen des 20. Jahrhunderts in der visuellen Kommunikation.
...
Das ist bei diesem Repository ein weniger kritisches Problem als bei LibreUIUX. Der Inhalt ist kompakter, die Fehleranfälligkeit geringer. Aber die strukturelle Fragilität bleibt: Was heute als „Saul Bass' Lesson" beschrieben ist, kann morgen inhaltlich falsch sein, ohne dass es jemand meldet.
