...
Ähnlich sauber ist der Umgang mit den Nielsen-Heuristiken. Kategorie 19 behandelt nicht alle zehn, sondern erklärt in der Referenzdatei `heuristics.md` ausdrücklich, dass H4, H5, H8 und H9 ausgeschlossen sind — mit Begründung, weil sie inhaltlich bereits in anderen Kategorien geprüft werden. Eine Skill-Datei, die von zehn Heuristiken sechs behandelt und das offen deklariert, ist methodisch ehrlicher als eine, die alle zehn behauptet und keine sauber portiert.
...
Genauso ehrlich ist die Regulatorik-Ebene. Die sechs Compliance-Prüfungen in Kategorie 18 — Cookie-Banner, Abo-Offenlegung, Datenschutzhinweis am Erhebungspunkt, Widerrufsrecht, Altersverifikation, Barrierefreiheits-Rechtslage — tragen jeweils den ausdrücklichen Vorbehalt, dies sei eine UI-Signalebene und kein Rechtsgutachten. Genau diese Unterscheidung fehlt sonst überall dort, wo Skills mit GDPR-Vokabular hantieren.
...
Rechnet man nach: 12 + 16 + 16 + 2 = 46. Und 100 − 46 = 54. Nicht 62. Acht Punkte Differenz, im einzigen vollständig durchgerechneten Beispiel der gesamten Dokumentation — in dem Beispiel also, das die Reproduzierbarkeit der Formel demonstrieren soll.
...
**Teil 2 — Trennschärfe prüfen.** Die Klasse teilt die Befunde eines Berichts in zwei Stapel: mechanisch entscheidbare (Kontrastverhältnis, fehlendes `<label>`, Abstand außerhalb des 8er-Rasters) und interpretationsbedürftige (Manipulationsvorwurf, Tonalität der Microcopy, Hierarchie der Handlungsaufforderung). Der erste Stapel lässt sich extern verifizieren, etwa mit einem Kontrastrechner. Der zweite nicht. Beide gehen mit demselben Gewicht in dieselbe Zahl ein — und das ist der Punkt, an dem die Diskussion beginnen sollte.
...
*Geprüft am 27. Juli 2026 gegen den Stand v1.2.13 (Release vom 17. Mai 2026), 57 Stars, 12 Forks, 84 Commits, MIT-Lizenz. Die Referenzdateien im Verzeichnis `references/` — darunter `ethics.md` und `heuristics.md` — waren zum Prüfzeitpunkt nicht direkt abrufbar; Aussagen dazu stützen sich auf README und Changelog des Repositorys sowie auf die Haupt-`SKILL.md`.*
